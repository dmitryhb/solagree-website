...
<template>
  <section
    class="attorney-how-it-works-section"
    aria-labelledby="attorney-how-it-works-title"
  >
    <div class="attorney-how-it-works-section__inner">
      <header
        v-appear
        class="attorney-how-it-works-section__header"
      >
        <h2
