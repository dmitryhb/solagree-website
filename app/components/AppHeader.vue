...
<template>
  <header
    ...
    @keydown.esc="() => { closeMobileMenu(); activeDropdown = '' }"
  >
    <div class="site-header__bar">
      ...
      >
        <HeaderDropdown
          id="site-header-couples-menu"
          :menu="headerCouplesMenu"
          :current-path="currentRoute.path"
          :current-full-path="currentRoute.fullPath"
          :active="activeDropdown === 'couples'"
          @open="activeDropdown = 'couples'"
        />
      ...
      >
        ...
        >
          <div class="site-header__mobile-resource-group">
            <p class="site-header__mobile-resource-label">{{ headerCouplesMenu.label }}</p>
            <NuxtLink
              v-for="link in headerCouplesMenu.links"
              :key="link.label"
