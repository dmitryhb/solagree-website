import type { CaseQualifierOutcomeId, CaseQualifierResultViewModel } from '~/data/case-qualifier-types'

export const solagreeCaseQualifierResultContent = {
  'possible-fit': {
...
} as const satisfies Record<CaseQualifierOutcomeId, CaseQualifierResultViewModel>
