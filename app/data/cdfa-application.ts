...
] as const satisfies readonly AttorneySelectOption<CdfaCertificationStatusValue>[]
...
] as const satisfies readonly AttorneySelectOption<CdfaClientExperienceValue>[]
...
] as const satisfies readonly AttorneySelectOption<CdfaSpecializationValue>[]
...
] as const satisfies readonly AttorneySelectOption<CdfaClientSourceValue>[]

export const cdfaConsultationInterestOptions = [
  { label: 'Yes', value: 'yes' },
  { label: 'No', value: 'no' },
  { label: 'Maybe - tell me more', value: 'maybe' }
] as const satisfies readonly AttorneySelectOption<CdfaConsultationInterestValue>[]
