export const cdfaCoBrandedPageTemplateSource = `
  <article class="co-branded-page co-branded-page--cdfa co-branded-page--{{#if isEmbed}}embed{{else}}standard{{/if}}">
    ...
    <section class="co-branded-page__hero" aria-labelledby="co-branded-hero-title">
      <div class="co-branded-page__hero-content">
        <p class="co-branded-page__hero-eyebrow">A Smarter Way to Divorce</p>
        <h1 id="co-branded-hero-title">
          <span>A Financial-First Path</span>
    ...
    <section class="co-branded-page__what-is" aria-labelledby="co-branded-what-is-title">
      <div class="co-branded-page__what-is-heading">
        ...
        <p>
          A virtual alternative to traditional court litigation that puts financial clarity first – even when you don't agree on everything.
        </p>
      </div>
    ...
    <section class="co-branded-page__attorney-guide" aria-labelledby="co-branded-attorney-guide-title">
      ...
      <div class="co-branded-page__attorney-guide-content">
        ...
        <p class="co-branded-page__attorney-guide-lede">
          We lead the financial foundation and work alongside you through every phase of the Solagree process:
        </p>
        ...
        <ul class="co-branded-page__attorney-guide-list">
          ...
          <li><strong>Before mediation</strong> - Leading the financial analysis, organizing your documents, and building a clear picture of your finances and options</li>
          <li><strong>Before arbitration</strong> - Reviewing what we've gathered, identifying key issues, and helping you prepare for productive conversations</li>
    ...
    <section class="co-branded-page__tracks" aria-labelledby="co-branded-tracks-title">
        ...
        <article class="co-branded-page__track-card">
          ...
          <div class="co-branded-page__track-includes">
            ...
            <ul class="co-branded-page__track-features">
              ...
              <li>Frameworks for ongoing decision-making</li>
            </ul>
          </div>
        </article>
      </div>
      ...
      <div class="co-branded-page__tracks-note">
        ...
        <p>We'll discuss Solagree platform fees and any additional services during your consultation.</p>
      </div>
    </section>
