...
const solagreeBasicTemplateSource = `
...
const solagreeBasicTemplate = Handlebars.compile<CoBrandedPageTemplateContext>(solagreeBasicTemplateSource)
const cdfaBasicTemplate = Handlebars.compile<CoBrandedPageTemplateContext>(cdfaBasicTemplateSource)

const templateRegistry = {
  'solagree-basic-v1': solagreeBasicTemplate,
  'cdfa-basic-v1': cdfaBasicTemplate
} as const
